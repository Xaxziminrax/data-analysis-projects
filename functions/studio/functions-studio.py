...
# join + reversed together
reversed_text = ''.join(reversed(text))

print(reversed_text)

def reverseCharacters(reverseString):
    joinedString = ''.join(reversed(list(reverseString)))
    return joinedString
print(reverseCharacters("potato"))
...
def numReverse(numToReverse):
    if type(numToReverse) is str:
        numStrReverse = reverseCharacters(numToReverse)
        return numStrReverse
    else:
        intNum = int(numToReverse)
        strNum = str(intNum)
        revNum = reverseCharacters(strNum)
        revNum = int(revNum)
        return revNum

print(numReverse("potato"))
print(numReverse(420420421))
...
def reverseList(tsil):
    emptiness = []
    for i in range(len(tsil)):
        tempList = numReverse(tsil[i])
        emptiness.insert(i, tempList)
        i += 1
        
    return emptiness

print(reverseList(list_test1))
print(reverseList(list_test2))
print(reverseList(list_test3))