...
adding_practice[len(adding_practice):len(adding_practice)] = [42]
print(adding_practice)

adding_practice[len(adding_practice):len(adding_practice)] = ["hello"]
print(adding_practice)

# Use list concatenation to add these three items to the list all at once: [False, -4.6, '87'].
adding_practice[len(adding_practice):len(adding_practice)] = [False, -4.6, '87']
print(adding_practice)
...
cargo_hold.append(1138)
cargo_hold.insert(0, '20 meters')
print(cargo_hold)
...
print('The list {cargo} contains {cargoLength} items.'.format(cargo = cargo_hold, cargoLength = len(cargo_hold)))