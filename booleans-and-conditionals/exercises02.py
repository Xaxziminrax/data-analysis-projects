...
# No, they do not produce the same results because space_suits_on could be False but return True
# due to the not in front of it. Code 1 returns "all systems go" with True, 200, True values
# Code 2 would return "all systems go" with True, 200, False values. 
